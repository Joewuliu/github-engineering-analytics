...
async def test_post_repositories_requires_authentication(
...
async def test_post_repositories_returns_201_with_created_repository(
    ...
    response = await client.post("/repositories", json={"full_name": "octocat/hello-world"})
...
async def test_post_repositories_persists_repository(
    ...
    await client.post("/repositories", json={"full_name": "octocat/persisted"})
...
async def test_post_repositories_invalid_full_name_returns_422_without_calling_github(
    ...
    response = await client.post("/repositories", json={"full_name": "no-slash-here"})
...
async def test_post_repositories_duplicate_returns_409(
    ...
    response = await client.post("/repositories", json={"full_name": "octocat/duplicate"})
...
async def test_post_repositories_github_404_returns_404(
    ...
    response = await client.post("/repositories", json={"full_name": "octocat/missing"})
